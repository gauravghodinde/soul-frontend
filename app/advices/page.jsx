                        ...
                        <div className="flex-1 overflow-y-scroll max-h-screen noScrollBar w-full">
                            <div className="min-h-screen flex flex-col justify-center items-center px-4 relative">
                                <div className="overflow-y-auto bg-gray-900 text-white p-6 rounded-md shadow-md w-full max-w-4xl">
                                    <div className="mb-6">
                                        <h3 className="text-3xl font-semibold">Advices</h3>
                                        <div className="mt-4">
                                            {responseData.ai_predictions && responseData.ai_predictions.length > 0 ? (
                                                responseData.ai_predictions.map((prediction, index) => (
                                                    <div key={index} className="bg-gray-800 p-4 rounded-md mb-4">
                                                        <h4 className="text-xl font-semibold text-purple-600">{prediction.question}</h4>
                                                        <p className="text-gray-300 mt-2">{prediction.answer}</p>
                                                    </div>
                                                ))
                                            ) : (
