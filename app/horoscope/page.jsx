            ...
            <Sidebar>
                <SidebarBody className="justify-between gap-10">
                    <div className="flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
                        <Link href="/" className="newChat bg-black px-5 py-3 rounded-lg text-xl hover:bg-gray-800 cursor-pointer">
                            <span>New Chat</span>
                        </Link>
                            ...
                            <div className="min-h-screen flex flex-col justify-center items-center px-4 relative">
                                <div className="overflow-y-auto bg-gray-900 text-white p-6 rounded-md shadow-md w-full max-w-4xl">
                                    <div className="mb-6 w-full">
                                        <h1 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-[#6800ad] to-[#c02af5] bg-clip-text text-transparent mb-1 text-center w-full px-4">
                                            Horoscope Analysis
                                        </h1>
                                        {/* Nakshatras Section */}
                                        <div className="mt-4 w-full">
                                            <h4 className="font-semibold text-lg mb-4">Nakshatras:</h4>
                                            <div className="overflow-x-auto">
                                                <table className="table-auto border-collapse border border-gray-300 w-full text-left">
                                                    <thead>
                                                        <tr className="bg-purple-600">
                                                            <th className="border border-gray-300 px-4 py-2">Planet</th>
                                                            <th className="border border-gray-300 px-4 py-2">Birth Nakshatra</th>
                                                            <th className="border border-gray-300 px-4 py-2">Transit Nakshatra</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {responseData.horoscope_analysis.nakshatras && responseData.horoscope_analysis.nakshatras.map((nakshatra, index) => (
                                                            <tr
                                                                key={index}
                                                                className={`${index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-900'}`}
                                                            >
                                                                <td className="border border-gray-300 px-4 py-2">{nakshatra.planet || 'N/A'}</td>
                                                                <td className="border border-gray-300 px-4 py-2">{nakshatra.birthNakshatra}</td>
                                                                <td className="border border-gray-300 px-4 py-2">{nakshatra.transitNakshatra}</td>
                                                            </tr>
                                                        ))}
                                                    </tbody>
                                                </table>
                                        ...
                                        <div className="mt-4 w-full">
                                            <h4 className="font-semibold text-lg mb-4">Dasha Periods:</h4>
                                            <div className="overflow-x-auto">
                                                <table className="table-auto border-collapse border border-gray-300 w-full text-left">
                                                    <thead>
                                                        <tr className="bg-purple-600">
                                                            <th className="border border-gray-300 px-4 py-2">Dasha Period</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {responseData.horoscope_analysis.dashaPeriods && responseData.horoscope_analysis.dashaPeriods.map((dashaPeriod, index) => (
                                                            <tr
                                                                key={index}
                                                                className={`${index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-900'}`}
                                                            >
                                                                <td className="border border-gray-300 px-4 py-2">{dashaPeriod.dashaPeriod}</td>
                                                            </tr>
                                                        ))}
                                                    </tbody>
                                                </table>
                                        ...
                                        <div className="mt-4 w-full">
                                            <h4 className="font-semibold text-lg mb-4">Planetary Aspects:</h4>
                                            <div className="overflow-x-auto">
                                                <table className="table-auto border-collapse border border-gray-300 w-full text-left">
                                                    <thead>
                                                        <tr className="bg-purple-600">
                                                    ...
                                                    <tbody>
                                                        {responseData.horoscope_analysis.planetaryAspects && responseData.horoscope_analysis.planetaryAspects.map((aspect, index) => (
                                                            <tr
                                                                key={index}
                                                                className={`${index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-900'}`}
                                                            >
                                        ...
                                        {/* Planetary Movements Section */}
                                        <div className="mt-4 w-full">
                                            <h4 className="font-semibold text-lg mb-4">Planetary Movements:</h4>
                                            <div className="overflow-x-auto">
                                                <table className="table-auto border-collapse border border-gray-300 w-full text-left">
                                                    <thead>
                                                        <tr className="bg-purple-600">
                                                            <th className="border border-gray-300 px-4 py-2">Planet</th>
                                                            <th className="border border-gray-300 px-4 py-2">Movement</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {responseData.horoscope_analysis.planetaryMovements && responseData.horoscope_analysis.planetaryMovements.map((movement, index) => (
                                                            <tr
                                                                key={index}
                                                                className={`${index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-900'}`}
                                                            >
                                                                <td className="border border-gray-300 px-4 py-2">{movement.planet}</td>
                                                                <td className="border border-gray-300 px-4 py-2">{movement.movement}</td>
                                                            </tr>
                                                        ))}
                                                    </tbody>
                                                </table>
